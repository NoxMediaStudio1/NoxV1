...
const DonatePage: React.FC = () => {
    ...
    const [currentGoal, setCurrentGoal] = useState({ current: 0, total: 2000 });
                                    ...
                                    {DONATION_OPTIONS.map(option => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                {isSelected && (
                                                    <div className="absolute -top-3 -left-3 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full p-2 shadow-lg">
  ...
  <button
    className="w-full py-4 px-6 rounded-xl font-semibold text-lg transition-all duration-300 transform bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white hover:scale-105 shadow-lg hover:shadow-xl"
  ...
  <div className="w-full py-4 px-6 rounded-xl font-semibold text-lg bg-slate-600 text-slate-300 opacity-50 cursor-not-allowed text-center select-none">
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="mt-8">
                            ...
                            <div className="flex flex-wrap justify-center gap-4 mt-6">
                                <a href="https://discord.gg/seuprojeto" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 rounded-lg bg-indigo-700 hover:bg-indigo-800 text-white font-medium transition">
                                ...
                                <a href="https://github.com/seuprojeto" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-800 hover:bg-slate-900 text-white font-medium border border-slate-600 transition">
                                ...
                                <a href="https://twitter.com/seuprojeto" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-500 hover:bg-blue-600 text-white font-medium transition">
